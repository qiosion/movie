...
public class MvFindDateDTO {
	...
	public MvFindDateDTO(int m_id, String m_date, int tt_num, String tt_scr_date, String tt_start, String tt_end,
			int th_max, String th_name, int tt_empty) {
		super();
		this.m_id = m_id;
		this.m_date = m_date;
		this.tt_num = tt_num;
