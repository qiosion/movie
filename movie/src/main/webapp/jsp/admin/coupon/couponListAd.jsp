...
<body>
	<div class="container">
		<form id="form1" class="form-horizontal">
			<div class="tit-heading-wrap tit-evt" style="margin-bottom: 10px;">
				<h3>쿠폰 등록 및 조회</h3>
			</div>
			<div class="form-group">
				<label>쿠폰번호:</label> <input type="text" class="form-control"
					name="cp_no">
			</div>
			<div class="form-group">
				<label>쿠폰이름:</label> <input type="text" class="form-control"
					name="cp_nm">
			</div>
			<div class="form-group">
				<label>유효기간:</label> <input type="date" name="cp_vaild_date">
			</div>
			<div class="form-group">
				<label>쿠폰종류:</label> <select class="form-control" name="cp_type">
			...
			<div class="form-group">
				<label>할인금액:</label> <select class="form-control" name="cp_discount">
