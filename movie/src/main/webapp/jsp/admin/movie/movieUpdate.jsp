							...
							<tbody>
								...
								<tr>
									...
									<td colspan="3"><textarea rows="3" cols="60" name="mvSum"
											id="mvSum">${vo.mvSum}</textarea></td>
								</tr>
								<tr>
									<td>설명</td>
									<td colspan="3"><textarea rows="3" cols="60" name="mvCont"
											id="mvCont">${vo.mvCont}</textarea></td>
								</tr>
							</tbody>
						</table>
					</div>
					...
					<table class="table">
						<tbody>
							...
							<tr style="float: center; text-align: center;">
								<td>티저 영상</td>
								<td><input type="hidden" name="prevTeaser" id="prevTeaser"
									value="${vo.mvTeaser}"> <!-- <input type="file" id="mvTeaser" name="mvTeaser"
									style="width: 50px;"></td>
								<td colspan="2"> --><c:if
